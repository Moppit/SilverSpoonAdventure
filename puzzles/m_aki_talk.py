...
class AkiTalk(Puzzle):
    ...
    def horse_talk(self):
        ...
        if int(roll) == 1:
            print("Natural 1: You notice she likes horses a lot.")
            print("\nHuilin: Yeah, horses are pretty cool, aren't they?")
        elif stat_check < 25:
            print("You notice that there's something else on her mind.")
            ...
            if response.lower().strip() == 'yes' or response.lower().strip() == 'y':
                ...
                while True:
                    ...
                    try:
                        ...
                        print("Enter an integer")
                if stat_check < 20:
                    print("Social Confidence Check less than 20: You do not feel confident enough to call out the connection you made")
                    print("\nHuilin: Yeah, horses are pretty cool, aren't they?")
                else:
